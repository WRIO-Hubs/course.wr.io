...
<html lang="en">
	...
	<head><base href=""/>
		...
		<link href="https://bizcom.wr.io/assets/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
		<link href="https://bizcom.wr.io/assets/plugins/custom/vis-timeline/vis-timeline.bundle.css" rel="stylesheet" type="text/css" />
	...
	<body data-kt-name="good" id="kt_app_body" data-kt-app-layout="light-sidebar" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default">
					...
					<div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
						...
						<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
							<a href="../index.html" class="d-lg-none">
								...
								<img alt="Logo" src="/assets/media/logos/default-dark.png" class="theme-dark-show h-30px" />
							</a>
						</div>
						<!--end::Mobile logo-->
						...
						<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
							...
							<div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_wrapper'}" class="page-title d-flex flex-column justify-content-center flex-wrap me-3 mb-5 mb-lg-0">
								...
								<!--begin::Description-->
								<span class="page-desc text-gray-400 fs-7 fw-semibold pt-1">You’ve got 0 New Tasks</span>
								<!--end::Description--></h1>
								<!--end::Title-->
							</div>
							<!--end::Page title-->
												...
												<div data-kt-search-element="results" class="d-none">
													...
													<div class="scroll-y mh-200px mh-lg-350px">
														...
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															...
															<!--begin::Title-->
															<div class="d-flex flex-column justify-content-start fw-semibold">
																<span class="fs-6 fw-semibold">Company Rebranding</span>
												...
												<div class="" data-kt-search-element="main">
													...
													<div class="scroll-y mh-200px mh-lg-325px">
														...
														<div class="d-flex align-items-center mb-5">
															...
															<!--begin::Title-->
															<div class="d-flex flex-column">
																<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">DemoApp</a>
														...
														<div class="d-flex align-items-center mb-5">
															...
															<!--begin::Title-->
															<div class="d-flex flex-column">
																<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">KPI Project</a>
														...
														<div class="d-flex align-items-center mb-5">
															...
															<!--begin::Title-->
															<div class="d-flex flex-column">
																<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">KPI Monitoring App</a>
														...
														<div class="d-flex align-items-center mb-5">
															...
															<!--begin::Title-->
															<div class="d-flex flex-column">
																<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">Help</a>
																<span class="fs-7 text-muted fw-semibold">#84250</span>
															</div>
															<!--end::Title-->
														</div>
														...
														<div class="d-flex align-items-center mb-5">
															...
															<!--begin::Title-->
															<div class="d-flex flex-column">
																<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">Mobile App</a>
				...
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
					...
					<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
						...
						<div class="app-sidebar-logo d-none d-lg-flex flex-stack flex-shrink-0 px-8" id="kt_app_sidebar_logo">
							<!--begin::Logo image-->
							<a href="../index.html">
								<img alt="Logo" src="/assets/media/logos/default.png" class="theme-light-show h-25px" />
								<img alt="Logo" src="/assets/media/logos/default-dark.png" class="theme-dark-show h-25px" />
							</a>
							<!--end::Logo image-->
							<!--begin::Menu wrapper-->
							<div class="ms-5">
						...
						<div class="app-sidebar-toolbar d-flex flex-stack py-6 px-8">
							<!--begin::Select-->
							<select class="form-select form-select-custom fw-bold" data-control="select2" data-placeholder="Select Project" data-hide-search="true">
								<option value="1" selected="selected">WRIO Ltd</option>
								<option value="2">ABC company</option>
							</select>
							<!--end::Select-->
							<!--begin::Button-->
							<a href="#" class="btn btn-icon btn-custom fw-bold flex-shrink-0 ms-3" data-bs-toggle="modal" data-bs-target="#kt_modal_create_project">
							...
							<div class="menu menu-column menu-sub-indention menu-active-bg fw-semibold" id="#kt_sidebar_menu" data-kt-menu="true">
								...
								<div class="menu-item pt-5">
									<div class="menu-content">
										<span class="menu-heading fw-bold text-uppercase fs-7">ORGANIZATIONS</span>
									</div>
								</div>
								<!--end:Menu item-->
								<!--begin:Menu item-->
								...
								<div class="menu-item pt-5">
									<!--begin:Menu content-->
									<div class="menu-content">
										<span class="menu-heading fw-bold text-uppercase fs-7">KNOWLEDGE BASES</span>
									</div>
									<!--end:Menu content-->
								</div>
								<!--end:Menu item-->
								<!--begin:Menu item-->
								<div class="menu-item">
									<a class="menu-link" href="kb_explore.html">
										<span class="menu-icon">
											<span class="svg-icon svg-icon-5">
												<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path d="M14.4 11H3C2.4 11 2 11.4 2 12C2 12.6 2.4 13 3 13H14.4V11Z" fill="currentColor" />
						...
						<div class="app-sidebar-user d-flex flex-stack py-5 px-8">
							...
							<div class="d-flex me-5">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div class="menu-item px-3">
											<div class="menu-content d-flex align-items-center px-3">
												...
												<!--begin::Username-->
												<div class="d-flex flex-column">
													<div class="fw-bold d-flex align-items-center fs-5">Brad Muller
													<span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Pro</span></div>
													<a href="#" class="fw-semibold text-muted text-hover-primary fs-7">info@wr.io</a>
												</div>
												<!--end::Username-->
											</div>
										</div>
								...
								<div class="me-2">
									<!--begin::Username-->
									<a href="#" class="app-sidebar-username text-gray-800 text-hover-primary fs-6 fw-semibold lh-0">Brad Muller</a>
									<!--end::Username-->
									<!--begin::Description-->
									<span class="app-sidebar-deckription text-gray-400 fw-semibold d-block fs-8">Product Owner</span>
									<!--end::Description-->
								</div>
								<!--end::Info-->
							</div>
								...
								<div id="kt_app_content_container" class="app-container container-fluid">
									<!--begin::Row-->
										<div class="row g-5 g-xxl-10">
											<!--begin::Col-->
											<div class="col-xl-12 mb-5 mb-xxl-5">
												...
												<div class="card bgi-position-y-bottom bgi-position-x-end bgi-no-repeat bgi-size-cover min-h-250px h-xl-100 border-0 bg-gray-200" style="background-position: 100% 100%;background-size: 500px auto;background-image:url('/assets/media/misc/city.png')">
													...
													<div class="card-body d-flex flex-column justify-content-center align-items-start ps-lg-15">
														<!--begin::Title-->
														<h3 class="text-gray-800 d-flex fs-2qx fw-bolder mb-4 mb-lg-8">!2Take the newcomer course to maximize your use of the BMP Dashboard</h3>
														<!--end::Title-->
														<!--begin::Action-->
														<div class="m-0">
															<!--begin::Action-->
															<a href="#" class="btn btn-danger fw-semibold me-6 mb-3" data-bs-target="#kt_modal_create_project" data-bs-toggle="modal">Start project</a>
															<!--end::Action-->
														</div>
														<!--begin::Action-->
													</div>
											...
											<div class="card-body pt-9 pb-0">
														...
														<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
															...
															<div class="d-flex flex-column">
																<div class="d-flex align-items-center mb-2">
																	<a href="#" class="text-gray-800 text-hover-primary fs-2 fw-bold me-1">Brad Muller</a>
																	<a href="#">
																...
																<div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
																	...
																	<!--end::Svg Icon-->info@wr.io</a>
																</div>
															</div>
															<!--end::User-->
															<!--begin::Actions-->
															<div class="d-flex my-4">
																<a href="#" class="btn btn-light btn-active-text-dark me-3" id="kt_user_follow_button">
														...
														<div class="d-flex flex-wrap justify-content-between">
															...
															<div class="d-flex flex-column flex-grow-1 pe-8">
																<div class="d-flex flex-wrap">
																	<div class="border border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
																		<div class="fs-1 fw-bold" data-kt-countup="true" data-kt-countup-value="6,840" data-kt-countup-prefix="$">0</div>
																	...
																	<div class="border border-dashed rounded min-w-125px py-2 px-4 me-6 mb-3">
																		<div class="fs-1 fw-bold" data-kt-countup="true" data-kt-countup-value="179">0</div>
																		<div class="fw-semibold fs-6 text-gray-400">New Referals</div>
																	</div>
																	<div class="border border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
																		<div class="fs-1 fw-bold" data-kt-countup="true" data-kt-countup-value="39">0</div>
																		<div class="fw-semibold fs-6 text-gray-400">New Deals</div>
																	</div>
																</div>
															</div>
															<!--end::Info-->
															...
															<div class="d-flex align-items-center w-200px w-sm-300px flex-column mt-3">
																<div class="d-flex justify-content-between w-100 mt-auto mb-2">
																	<span class="fw-semibold fs-6 text-gray-400">Profile Status</span>
												...
												<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
													...
													<li class="nav-item mt-2">
														<a class="nav-link text-active-primary ms-0 me-10 py-5" href="/dashboard">Overview</a>
													</li>
													<!--end::Nav item-->
													<!--begin::Nav item-->
													<li class="nav-item mt-2">
														<a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="#">Projects</a>
													</li>
													<!--end::Nav item-->
													<!--begin::Nav item-->
													<li class="nav-item mt-2">
							...
							<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
								...
								<div class="d-flex flex-column flex-column-fluid">
									...
									<div id="kt_app_content" class="app-content flex-column-fluid">
										...
										<div id="kt_app_content_container" class="app-container container-fluid">
												<!--begin::Row-->
												<div class="row g-5 g-xl-10 mb-5 mb-xl-10" id="Projects"></div>
												<!--end::Row-->
										</div>
										<!--end::Content container-->
									</div>
						...
						<div id="kt_app_footer" class="app-footer">
							...
							<div class="app-container container-fluid d-flex flex-column flex-md-row flex-center flex-md-stack py-3">
								...
								<div class="text-dark order-2 order-md-1">
									...
									<a href="https://wr.io" target="_blank" class="text-gray-800 text-hover-primary">WRIO Ltd</a>
								</div>
								<!--end::Copyright-->
								<!--begin::Menu-->
					...
					<div class="scroll-y me-n5 pe-5" data-kt-element="messages" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_drawer_chat_messenger_header, #kt_drawer_chat_messenger_footer" data-kt-scroll-wrappers="#kt_drawer_chat_messenger_body" data-kt-scroll-offset="0px">
						...
						<div class="d-flex justify-content-start mb-10">
							...
							<div class="d-flex flex-column align-items-start">
								...
								<!--end::User-->
								<!--begin::Text-->
								<div class="p-5 rounded bg-light-info text-dark fw-semibold mw-lg-400px text-start" data-kt-element="message-text">Company WRIO Ltd to celebrate the last quater achievements and goals. Food and drinks provided</div>
								<!--end::Text-->
							</div>
							<!--end::Wrapper-->
						</div>
				...
				<div class="card-body" id="kt_help_body">
					...
					<div id="kt_help_scroll" class="hover-scroll-overlay-y" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_help_body" data-kt-scroll-dependencies="#kt_help_header" data-kt-scroll-offset="5px">
						...
						<div class="rounded border border-dashed border-gray-300 p-6 p-lg-8 mb-10">
							...
							<a href="https://wr.io" class="">wr.io</a></h2>
							<!--end::Heading-->
							<!--begin::Description-->
							<div class="fs-5 fw-semibold mb-5">
								...
								<a class="explore-link d-none" href="https://wr.io">FAQs</a>
							</div>
							<!--end::Description-->
							<!--begin::Link-->
							<a href="https://wr.io" class="btn btn-lg explore-btn-primary w-100">Get Support</a>
							<!--end::Link-->
						</div>
						<!--end::Support-->
						<!--begin::Link-->
						<div class="d-flex align-items-center mb-7">
							...
							<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
								...
								<div class="d-flex flex-column me-2 me-lg-5">
									<!--begin::Title-->
									<a href="../documentation/getting-started.html" class="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">Documentation</a>
									<!--end::Title-->
									<!--begin::Description-->
									...
									<div class="current" data-kt-stepper-element="content">
										...
										<div class="w-100">
											...
											<div class="pb-7 pb-lg-12">
												...
												<!--end::Title-->
												<!--begin::Description-->
												<div class="text-muted fw-semibold fs-4">For more information, please check out the
												<a href="knowledge_base.html" class="link-primary fw-bold">Knowledge Base</a></div>
												<!--end::Description-->
											</div>
											<!--end::Heading-->
											<!--begin::Input group-->
											<div class="fv-row mb-15" data-kt-buttons="true">
												...
												<!--end::Option-->
												<!--begin::Option-->
												<label class="disabled btn btn-outline btn-outline-dashed btn-active-light-primary d-flex text-start p-6">
													<!--begin::Input-->
													...
													<span class="d-flex">
														...
														<!--begin::Info-->
														<span class="ms-4">
															<span class="fs-3 fw-bold text-gray-900 mb-2 d-block">Team Project <span class="badge badge-info ms-2 fs-7">Coming</span></span>
									...
									<div data-kt-stepper-element="content">
										...
										<div class="w-100">
											...
											<div class="fv-row mb-8">
												...
												<!--end::Label-->
												<!--begin::Input-->
												<input type="text" class="form-control form-control-solid" placeholder="Enter Project Name" value="" name="settings_name" />
												<!--end::Input-->
											</div>
											<!--end::Input group-->
											<!--begin::Input group-->
										...
										<div class="w-100">
											...
											<div class="fv-row mb-8">
												...
												<div class="position-relative w-lg-250px" id="kt_modal_create_project_budget_setup" data-kt-dialer="true" data-kt-dialer-min="0" data-kt-dialer-max="50000" data-kt-dialer-step="50" data-kt-dialer-prefix="$" data-kt-dialer-decimals="0">
													...
													<!--begin::Input control-->
													<input type="text" class="form-control form-control-solid border-0 ps-12" data-kt-dialer-control="input" placeholder="Amount" name="budget_setup" readonly="readonly" value="$0" />
													<!--end::Input control-->
											...
											<div class="d-flex flex-stack">
												...
												<button id='create' type="button" class="btn btn-lg btn-primary" data-kt-element="budget-next">
									...
									<div data-kt-stepper-element="content">
										...
										<div class="w-100">
											...
											<div class="d-flex flex-center pb-20">
												<button type="button" class="btn btn-lg btn-light me-3" data-bs-dismiss="modal">Close</button>
											</div>
											<!--end::Actions-->
											<!--begin::Illustration-->
											<div class="text-center px-4">
									...
									<div class="mh-375px scroll-y me-n7 pe-7">
										...
										<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="2">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Details-->
												<div class="ms-5">
													<a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Brad Muller</a>
													<div class="fw-semibold text-muted">info@wr.io</div>
												</div>
												<!--end::Details-->
											</div>
											<!--end::Details-->
		...
		<script src="https://bizcom.wr.io/assets/js/custom/utilities/modals/upgrade-plan.js"></script>
		<script src="https://bizcom.wr.io/assets/js/custom/utilities/modals/create-project/type.js"></script>
		<script src="https://bizcom.wr.io/assets/js/custom/utilities/modals/create-project/budget.js"></script>
		<script src="https://bizcom.wr.io/assets/js/custom/utilities/modals/create-project/settings.js"></script>
		<script src="https://bizcom.wr.io/assets/js/custom/utilities/modals/create-project/team.js"></script>
		<script src="https://bizcom.wr.io/assets/js/custom/utilities/modals/create-project/targets.js"></script>
		<script src="https://bizcom.wr.io/assets/js/custom/utilities/modals/create-project/files.js"></script>
		<script src="https://bizcom.wr.io/assets/js/custom/utilities/modals/create-project/complete.js"></script>
		<script src="https://bizcom.wr.io/assets/js/custom/utilities/modals/create-project/main.js"></script>
		<script src="https://bizcom.wr.io/assets/js/custom/utilities/modals/create-app.js"></script>
		<script src="https://bizcom.wr.io/assets/js/custom/utilities/modals/create-campaign.js"></script>
		<script src="https://bizcom.wr.io/assets/js/custom/utilities/modals/users-search.js"></script>
		...
		<script>
			...
			var loadProjects = function() {
					...
					base('Projects').select({
							filterByFormula: 'ID_from_Organizations = "1"',
							sort: [
			...
			<link href="/assets/css/style.bundle.css" rel="stylesheet" type="text/css" />
				<div class="card card-flush h-xl-100">
					<div class="card-body text-center pb-5">
						<div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7" style="height: 266px;background-image:url('/assets/media/misc/no_img.gif"></div>
						<div class="d-flex align-items-end flex-stack mb-1">
							<div class="text-start">
								<span class="fw-bold text-gray-800 cursor-pointer text-hover-primary fs-4 d-block"><slot name="element-name">Name</slot></span>
								<slot name="element-completion">completion %</slot>
								<slot name="element-status">status</slot>
								<span class="text-gray-400 mt-1 fw-bold fs-6"><slot name="element-description">description</slot></span>
								<span class="text-gray-400 mt-1 fw-bold fs-6"><slot name="element-budget">budget</slot></span>
							</div>
						</div>
					</div>
					<div class="card-footer d-flex flex-stack pt-0">
						<slot name="element-action-delete">Delete</slot>
						<slot name="element-action-details"><a class="btn btn-sm btn-light flex-shrink-0" href="/organizations">Details</a></slot>
					</div>
				</div>
		</template>
	</body>
