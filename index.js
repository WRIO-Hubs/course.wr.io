  ...
  async fetch(request) {
    ...
    <html lang="en">
    	...
    	<head>
    		...
    		<link rel="shortcut icon" href="http://bizcom.wr.io/assets/media/logos/favicon.ico" />
    		<!--begin::Fonts-->
    					...
    					<div class="container-xxl">
    						...
    						<div class="d-flex align-items-center">
    							...
    							<div class="d-flex align-items-center me-8">
    								...
    								<!--begin::Logo image-->
    								<a href="http://bizcom.wr.io/" target="_blank">
    	...
    	<!--end::Svg Icon-->    <!--end::Icon-->    <!--begin::Description-->    <div class="text-gray-700 fw-bold fs-6">
    	                Secure your pre-access to the <a href="http://bizcom.wr.io/" target="_blank">service</a> by joining our course today!
    							  ...
    							  <script>
    							    ...
    							    button.addEventListener("click", function(event) {
    							      ...
    							      if (isValidEmail(emailInput)) {
    							        ...
    							        window.open('https://script.google.com/macros/s/AKfycbzFVOvryi6kxaWieprXHWnEMlNd4TU-3wZ8h5q6BRhLiQvO1KyX7ixq4qkwzOqpnifkMg/exec?gid=0&email=' + emailInput, '_self');
    ...
    Completing this course will equip you with the essential knowledge and skills to grow and expand your business further on the <a href="http://bizcom.wr.io/">BizCom</a> platform.
    <br>&nbsp;</span>
    															</div>
    															<!--end::Text-->
    															<!--begin::Item-->
    		...
    		<!--end::Scrolltop-->
    		<!--begin::Javascript-->
    		<script>var hostUrl = "https://bizcom.wr.io/assets/";</script>
